...
public class NetworkManagerVisitor extends ClassVisitor {
    ...
    public static class SendPacketVisitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "me/thef1xer/gateclient/util/EventFactory", "onSendPacket", "(Lnet/minecraft/network/Packet;)Lnet/minecraft/network/Packet;", false);
    ...
    public static class ChannelRead0Visitor extends MethodVisitor {
        ...
        public void visitCode() {
            ...
            mv.visitMethodInsn(INVOKESTATIC, "me/thef1xer/gateclient/util/EventFactory", "onReceivePacket", "(Lnet/minecraft/network/Packet;)Lnet/minecraft/network/Packet;", false);
