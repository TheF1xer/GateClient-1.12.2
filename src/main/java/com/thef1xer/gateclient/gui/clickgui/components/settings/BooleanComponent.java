...
public class BooleanComponent extends ClickComponent {
    ...
    public void drawComponent(int mouseX, int mouseY, float partialTicks) {
        ...
        if (this.setting.getValue()) {
            RenderUtil.draw2DRect(this.posX + this.width - this.border - 8, this.posY + this.border, this.posX + this.width - this.border, this.posY + this.border + 8, 0.85F, 0.43F, 0F, 1F);
        }
        RenderUtil.draw2DRectLines(this.posX + this.width - this.border - 8, this.posY + this.border, this.posX + this.width - this.border, this.posY + this.border + 8, 0.8F, 0.8F, 0.8F, 0.8F);
    }
